...
<div class="mdui-container doc-container">
    ...
    <div class="doc-chapter mdui-typo">
        <h2 id="app-init"><a href="#app-init">初始化应用</a></h2>
...
<html>
    ...
    <body>
        ...
        <h2 id="app-model"><a href="#app-model">创建模型</a></h2>
...
module.exports = User'); ?></code></pre>
        ...
        <h2 id="app-view"><a href="#app-view">创建视图</a></h2>
...
module.exports = {
    ...
    view: function() {
        ...
        <h2 id="app-mount"><a href="#app-mount">渲染视图</a></h2>
...
m.mount(document.body, UserList)'); ?></code></pre>
        ...
        <h2 id="app-style"><a href="#app-style">添加样式</a></h2>
...
.user-list-item:hover {text-decoration:underline;}'); ?></code></pre>
        ...
        <h2 id="add-route"><a href="#add-route">添加路由</a></h2>
...
m.route(document.body, "/list", {
    "/list": UserList
        ...
        <h2 id="app-edit"><a href="#app-edit">编辑用户</a></h2>
...
module.exports = {
    ...
    view: function() {
        ...
        <h2 id="app-save"><a href="#app-save">保存用户</a></h2>
...
module.exports = User'); ?></code></pre>
        ...
        <h2 id="app-layout"><a href="#app-layout">组件布局</a></h2>
...
m.route(document.body, "/list", {
    ...
    "/edit/:id": {
        ...
        <h2 id="app-end"><a href="#app-end">结束</a></h2>
        <p>本教程到此结束。</p>
