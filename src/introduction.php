...
<div class="mdui-container doc-container">
    ...
    <div class="doc-chapter">
        ...
        <h2 id="getting-started" class="doc-chapter-title mdui-text-color-theme"><a href="#getting-started">起步</a></h2>
        <div class="doc-chapter-content mdui-typo">
    ...
    // your code goes here!
        ...
        <h2 id="hello-world" class="doc-chapter-title mdui-text-color-theme"><a href="#hello-world">Hello World</a></h2>
        <div class="doc-chapter-content mdui-typo">
...
m.render(root, "Hello world")'); ?></code></pre>
        ...
        <h2 id="dom-elements" class="doc-chapter-title mdui-text-color-theme"><a href="#dom-elements">DOM 元素</a></h2>
        <div class="doc-chapter-content mdui-typo">
...
m.mount(root, Hello)'); ?></code></pre>
        ...
        <h2 id="routing" class="doc-chapter-title mdui-text-color-theme"><a href="#routing">路由</a></h2>
        <div class="doc-chapter-content mdui-typo">
    ...
    "/hello": Hello,
        ...
        <h2 id="xhr" class="doc-chapter-title mdui-text-color-theme"><a href="#xhr">XHR</a></h2>
        <div class="doc-chapter-content mdui-typo">
            <p>XHR 是与服务器通信的方式。</p>
...
var increment = function() {
    ...
    view: function() {
        ...
        <h2 id="summary" class="doc-chapter-title mdui-text-color-theme"><a href="#summary">总结</a></h2>
        <div class="doc-chapter-content mdui-typo">
