...
<div class="mdui-container doc-container">
    ...
    <div class="doc-chapter">
        ...
        <h2 id="npm" class="doc-chapter-title mdui-text-color-theme"><a href="#npm">NPM</a></h2>
        <div class="doc-chapter-content mdui-typo">
            ...
            <h3 class="doc-chapter-subtitle">模块化</h3>
  ...
  <body>
    <script src="bin/app.js"></script>
            ...
            <h3 class="doc-chapter-subtitle">模块的导入导出</h3>
...
m.mount(document.body, MyComponent)');?></code></pre>
    ...
    "scripts": {
        ...
        <h2 id="other" class="doc-chapter-title mdui-text-color-theme"><a href="#other">其他相关介绍</a></h2>
        <div class="doc-chapter-content mdui-typo">
            <h3 class="doc-chapter-subtitle">开发环境的 live reload</h3>
...
npm start');?></code></pre>
            ...
            <h3 class="doc-chapter-subtitle">Mithril bundler</h3>
    ...
    "scripts": {
        "build": "bundle index.js --output app.js --watch"
            ...
            <h3 class="doc-chapter-subtitle">Vanilla</h3>
