...
<div class="mdui-container doc-container">
    ...
    <div class="doc-chapter mdui-typo">
        <h2 id="technology-choices"><a href="#technology-choices">技术选型</a></h2>
        ...
        <h2 id="animation-on-element-creation"><a href="#animation-on-element-creation">元素创建时的动画</a></h2>
...
m.mount(document.body, FancyComponent)'); ?></code></pre>
        ...
        <h2 id="animation-on-element-removal"><a href="#animation-on-element-removal">元素移除时的动画</a></h2>
...
var Toggler = {
    ...
    view: function() {
        ...
        <h2 id="performance"><a href="#performance">性能</a></h2>
