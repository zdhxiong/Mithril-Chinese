...
// <div style="color:red;">Hello world</div>'); ?></code></pre>
        ...
        <h2 id="vnode-types" class="doc-chapter-title mdui-text-color-theme"><a href="#vnode-types">vnode 类型</a></h2>
        <div class="doc-chapter-content mdui-typo">
        ...
        <h2 id="monomorphic-class" class="doc-chapter-title mdui-text-color-theme"><a href="#monomorphic-class">单态类</a></h2>
        <div class="doc-chapter-content mdui-typo">
        ...
        <h2 id="avoid-anti-patterns" class="doc-chapter-title mdui-text-color-theme"><a href="#avoid-anti-patterns">避免反面模式（anti-patterns）</a></h2>
        <div class="doc-chapter-content mdui-typo">
            <h3 class="doc-chapter-subtitle">避免存储可变 vnode</h3>
