...
o.spec("math", function() {
    o("addition works", function() {
        ...
        <h2 id="good-testing-practices" class="doc-chapter-title mdui-text-color-theme"><a href="#good-testing-practices">良好的测试实践</a></h2>
        <div class="doc-chapter-content mdui-typo">
        ...
        <h2 id="unit-testing" class="doc-chapter-title mdui-text-color-theme"><a href="#unit-testing">单元测试</a></h2>
        <div class="doc-chapter-content mdui-typo">
