...
<div class="mdui-container doc-container">
    <h1 class="doc-title mdui-text-color-theme">自动重绘系统</h1>
    ...
    <div class="doc-chapter">
        ...
        <div class="doc-chapter-content mdui-typo">
            ...
            <h3 id="after-event-handlers" class="doc-chapter-subtitle">事件处理函数之后</h3>
...
m.mount(document.body, MyComponent)'); ?></code></pre>
            ...
            <h3 id="after-request" class="doc-chapter-subtitle">m.request 之后</h3>
    ...
    // 不再触发自动重绘
            ...
            <h3 id="after-route-changes" class="doc-chapter-subtitle">路由改变之后</h3>
...
m.route(document.body, "/", {
    "/": RoutedComponent,
        ...
        <h2 id="when-mithril-does-not-redraw" class="doc-chapter-title mdui-text-color-theme"><a href="#when-mithril-does-not-redraw">何时不进行重绘</a></h2>
        <div class="doc-chapter-content mdui-typo">
