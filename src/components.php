...
// <div>Hello</div>'); ?></code></pre>
        ...
        <h2 id="passing-data-to-components"><a href="#passing-data-to-components">把数据传递到组件</a></h2>
...
m(ComponentWithHooks, {oninit: initialize})'); ?></code></pre>
        ...
        <h2 id="state"><a href="#state">状态</a></h2>
...
// <div>Initial content</div>'); ?></code></pre>
        ...
        <h3>通过 <code>vnode.state</code></h3>
